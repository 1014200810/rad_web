 ...
 * @Version: 2.0
 * @Autor: 葛璐豪
 * @Date: 2020-10-14 17:10:30
 * @LastEditors: Seven
 * @LastEditTime: 2020-10-30 20:20:19
 */
/* 初始化设置 */
function d3_rgbString (value) {
  let r = (value>>16).toString(16)
  let g = (value>>8&0xff).toString(16)
  let b = (value&0xff).toString(16) 
  r = r.length==1?'0'+r:r
  b = b.length==1?'0'+b:b
  g = g.length==1?'0'+g:g
  return '#'+r+g+b
...
module.exports = {
   d3_category437: [  
    0xd3fe14, 0xfec7f8, 0x0b7b3e, 0x0bf0e9, 0xc203c8, 0xfd9b39, 
    ...
    0x81ffad,           0x646a58, 0xd5097e, 0xbb73a9, 
  ...
  // 态势颜色编码
  stu_color: [
    // '#cddb8f', '#f0e68c', '#f4a460', '#d15d5e', '#9c6680'
    '#8ac836', '#ecf414', '#ffa200', '#ff786d', '#cb0f09'
  ],
  // 频谱强度配色
  dbm_color: ['#a7fffe', '#2cd4f9', '#327796', '#2e2e2e'],
  dbm_domain: [0, -25, -75, -100],
  freqslot: [
    932, 962
  ],
  timeRange: [  //这是默认时间
    '2020-09-21 11:16:08', '2020-09-21 11:16:48'
  ],
  MaxFreRange: [1290,1326], //这是最大范围
  freRange: [1290,1326],  //这是默认范围
  idMin: 3208,
  idMax: 3208+119,
  idInitSelectLength: 10
}
